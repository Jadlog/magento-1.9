...
class DPDFrance_Relais_Model_Carrier_DPDFranceRelaisShipping extends Mage_Shipping_Model_Carrier_Abstract
{
    ...
    protected function _process(&$process)
    {
        ...
        // $this->_setError($process, "Mensagem de teste");
        // $logger = Mage::getModel('core/log_adapter')->log("cheguei ate aqui");
    }
    ...
    {
        Mage::getModel('core/log_adapter')->log("relais - collectRates - start");
        $cpfOrCnpj = '';
        ...
        try {
            ...
            Mage::register('cpfOrCnpj', $cpfOrCnpj, true);
            Mage::register('vlDec', $process['data']['cart.price_including_tax'], true);
            ...
            Mage::register('pesoCubadoTotal', $pesoTaxado, true);
            
            $this->_process($process);
//             Mage::getModel('core/log_adapter')->log("process[result]: ".print_r($process['result'], true));
            return $process['result'];
        } catch (Exception $e) {
            Mage::logException($e);
        }
    ...
    {
//         Mage::getModel('core/log_adapter')->log("getTrackingInfo-trackingNumber: $trackingNumber");
